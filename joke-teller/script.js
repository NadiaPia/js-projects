...
// VoiceRSS Javascript SDK software development kit
...
function tellMe(joke) {
    ...
    VoiceRSS.speech({
        key: SECRET, //also we can store it in our server because only we will have an access
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
audioElement.addEventListener('ended', toggleButton) //https://www.w3schools.com/tags/ref_av_dom.asp
